...
<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
  ...
  <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item" href="#">ADD RESULTS</a>
...
<div class="container">
		...
		<div class="modal fade" id="myModal" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
					<h4 class="modal-title text-primary">ADD STUDENT RESULTS</h4>
			...
			<form:form action="" method="post" modelAttribute="${pageContext.request.contextPath }/aitiKaceStudentsApiConsumption/findnRetrieveAllStudentNames">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<form:input path="student_name" readonly="true" value="${findnRetrieveAllStudentNames.student_name }" class="form-control" />
								</div>
...
<!-- 
								<div class="form-group">
									...
									<form:select path="course_level" class="form-control" required="true">
			...
			<c:forEach items="${findnRetrieveAllStudentNames}" var="findnRetrieveAllStudentNames">

						<label>SELECT STUDENT</label> 
						<form:select path="student_name" class="form-control" required="required">
						<option>Select Student</option>
										
						<form:option path="student_name" value="${findnRetrieveAllStudentNames.student_name }"></form:option>
