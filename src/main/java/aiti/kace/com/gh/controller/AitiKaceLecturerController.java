...
public String studentLoginAction(@RequestParam("email") String email, @RequestParam("password") String password) throws SQLException, ClassNotFoundException {
	...
	if(rs.next()){
		...
		return "redirect: /myProjectTrials/aitiKaceAdminApiConsumption/getAllStudentInfo=VIEW=ADMIN-JJD-DN-OSPS-PAGE-Jkdiso=dDFSFUJD-DNDNjfdhnd=dkdoeyrijfd-cnfsd";
